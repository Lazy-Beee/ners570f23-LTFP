...
int main()
{
    ...
    Real temp1 = 10.0f;
    COMPARE(tb1->getTemp(pos1, temp1), 0.0f, 1e-3f, "getTemp 1");
    COMPARE(tb1->getFlux(pos1, temp1), 8.0f, 1e-3f, "getFlux 1");
    ...
    Real temp2 = 10.0f;
    COMPARE(tb2->getTemp(pos2, temp2), 41.0f, 1e-3f, "getTemp 2");
    COMPARE(tb2->getFlux(pos2, temp2), 0.0f, 1e-3f, "getFlux 2");
    ...
    Real temp3 = 310.0f;
    COMPARE(tb3->getTemp(pos3, temp3), 0.0f, 1e-3f, "getTemp 3");
    COMPARE(tb3->getFlux(pos3, temp3), -150.0f, 1e-3f, "getFlux 3");
    ...
    Real temp4 = 310.0f;
    COMPARE(tb4->getTemp(pos4, temp4), 0.0f, 1e-3f, "getTemp 4");
    COMPARE(tb4->getFlux(pos4, temp4), -643.664f, 1e-3f, "getFlux 4");
    ...
    Real temp5 = 310.0f;
    COMPARE(tb5->getTemp(pos5, temp5), 310.0f, 1e-3f, "getTemp 5");
    COMPARE(tb5->getFlux(pos5, temp5), 0.0f, 1e-3f, "getFlux 5");
#endif
